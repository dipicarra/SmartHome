            ...
            <form id="routineForm">
                ...
                <div id="activity-fieldsets">
                    ...
                    <fieldset class="location-options" id="locationOptions">
                        ...
                        <input type="checkbox" id="routineEnvironmentOption-${environment.name}" name="room" value="${environment.name}">
...
function displayRoutines(displayMain = false) {
    ...
    routines.forEach((routine, index) => {
        ...
        routine.tasks.forEach(task => {
            const taskDetails = ` ${task.taskname}: ${task.state !== null ? task.state + ' ' : ''} ${task.range !== null ? task.range + '% ' : ''}\
        ...
        ${lang == "en" ? "on" : "na/no"}: ${routine.weekdays.join(', ')}`;

...
if (document.body.id == "SmartHomePage") {
    ...
    if (languageSelect.value === 'pt') {
        ...
        document.getElementById("helpText1").innerText = 'Vídeo de ajuda para a realização do primeira tarefa:';
        document.getElementById("helpText2").innerText = 'Vídeos de ajuda para a realização da segunda tarefa:';
        document.getElementById("helpText222").innerText = 'Há uma série de métodos diferentes para encomendar as compras';
        document.getElementById("helpText21").innerText = 'Primeiro método:';
        document.getElementById("helpText22").innerText = 'Segundo método:';
        document.getElementById("helpText23").innerText = 'Terceiro método:';
        document.getElementById("helpText3").innerText = 'Vídeo de ajuda para a realização da terceira tarefa:';
        document.getElementById("helpText4").innerText = 'Vídeo de ajuda para a realização da quarta tarefa:';
        document.getElementById('user-address').innerHTML = `Sua morada:
        <br>
        Rua Nicki,<br> 
        Nº 123,<br>
        ...
        document.getElementById("helpText1").innerText = 'Help video for the completion of the first task:';
        document.getElementById("helpText2").innerText = 'Help videos for the completion of the second task:';
        document.getElementById("helpText222").innerText = 'There are a bunch of different methods how you can ordes groceries';
        document.getElementById("helpText21").innerText = 'First method:';
        document.getElementById("helpText22").innerText = 'Second method:';
        document.getElementById("helpText23").innerText = 'Third method:';
        document.getElementById("helpText3").innerText = 'Help video for the completion of the third task:';
        document.getElementById("helpText4").innerText = 'Help video for the completion of the fourth task:';
    }
}

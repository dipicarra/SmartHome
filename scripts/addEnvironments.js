...
if (localStorage.getItem("environments")) {
    ...
    addEnvironment("Office", "Office",
        officeIds, { "addOfficeLights": 2, "addOfficeBlinds": 3 });
    addEnvironment("Kitchen", "Kitchen",
        kitchenIds, { "addKitchenLights": 7, "addKitchenBlinds": 3, "addKitchenTV": 1 });
    addEnvironment("Living Room", "Living Room",
        livingRoomIds, { "addLivingRoomLights": 8, "addLivingRoomTV": 2, "addLivingRoomBlinds": 8 });
    addEnvironment("Bedroom", "Bedroom",
        bedroomIds, { "addBedroomLights": 5, "addBedroomTV": 1, "addBedroomBlinds": 4 });
    addEnvironment("Bathroom", "Bathroom",
        bathroomIds, { "addBathroomLights": 4, "addBathroomBlinds": 1 });
